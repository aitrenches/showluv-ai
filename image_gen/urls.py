...
from .views import ImageGenerator, ProductCreateView, ProductDetailView, AddProductQuantityView, SellProductView, SalesHistoryView
...
urlpatterns = [
    ...
    path('products/add-quantity/', AddProductQuantityView.as_view(), name='add-product-quantity'),
